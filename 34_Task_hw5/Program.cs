// homework 5 Task 34: Задайте массив, заполненный случайными положительными (№31)
...
// cem5 Задача 31: Задайте массив из 12 элементов, заполненный случайными числами из промежутка [-9, 9]. 
...
// for (int i = 0; i < array.Length; i++)
// {
//     array[i] = new Random().Next(-9, 10);//создавали случайн переменую 12 раз
//     if (array[i] > 0)
//     {
